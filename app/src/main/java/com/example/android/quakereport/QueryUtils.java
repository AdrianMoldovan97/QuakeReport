    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i =0; i< jsonArray.length(); i++){
                ...
                JSONObject jsonObject1Properties= jsonObject.getJSONObject("properties");
                double magnitude = jsonObject1Properties.getDouble("mag");
                String place= jsonObject1Properties.getString("place");
                long timeInMiliseconds = jsonObject1Properties.getLong("time");
                String url = jsonObject1Properties.getString("url");

                Earthquake earthquake = new Earthquake(magnitude, place, timeInMiliseconds, url);
